...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    const addMessage = (text, isUser = false, timestamp = new Date()) => {
        ...
        time极速赛车开奖结果Stamp.className = 'timestamp';
            ...
            socket.onmessage = (event) => {
                ...
                try {
                    ...
                    if (data.type === "transcription" && data.end_of_turn) {
                        // Display transcription only at极速赛车开奖结果 end of turn
                    ...
                    } else if (data.type === "极速赛车开奖结果error") {
                        console.error("Transcription error:", data.message);
                        statusDisplay.textContent = `Error: ${极速赛车开奖结果data.message}`;
